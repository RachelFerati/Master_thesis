...
-   <a
    ...
    -   <a href="#histogram-to-check-for-variability"
        ...
        variability</a>
    -   <a href="#show-the-mean-and-median"
        id="toc-show-the-mean-and-median">Show the mean and median</a>
...
The Shannon index can be used to analyze and compare the diversity
...
After observing the normal distribution of the Shannon index within the
dataset, we will have a look at the distribution of the total of
emotional words.
